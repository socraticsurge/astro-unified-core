...
export async function GET(req: NextRequest) {
  ...
  const cached = await db.readings.latestByEngine(profile_id, "panchangam");
  if (cached) {
  ...
  await db.readings.save({ profile_id, engine: "panchangam", input_snapshot: input, output_data: output });
