...
export async function GET(req: NextRequest) {
  ...
  const cached = await db.readings.latestByEngine(profile_id, "western");
  if (cached) {
  ...
  await db.readings.save({ profile_id, engine: "western", input_snapshot: input, output_data: output });
