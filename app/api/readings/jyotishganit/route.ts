...
export async function GET(req: NextRequest) {
  ...
  const cached = await db.readings.latestByEngine(profile_id, "jyotishganit");
  if (cached) {
  ...
  await db.readings.save({ profile_id, engine: "jyotishganit", input_snapshot: input, output_data: output });
