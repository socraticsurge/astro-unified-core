...
export async function GET(req: NextRequest) {
  ...
  const cached = await db.readings.latestByEngine(profile_id, "stellium");
  if (cached) {
  ...
  await db.readings.save({ profile_id, engine: "stellium", input_snapshot: input, output_data: output });
